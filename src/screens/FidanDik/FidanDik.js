        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.pickText}>
                    Fidanınızı dikmek için bir dikim alanı seçin
                </Text>
            </View>
            {/* Pick Location */}
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: "white", margin: 2 }}>
                                Belirtilen alana fidanını dikmek üzeresin, Onaylıyor musun ?
                            </Text>
                        </Callout>
                    </Marker>
            ...
            <View style={styles.pickedLoc}>
                <Text style={styles.titleLoc}>Seçilen Alan</Text>
                <TextInput style={styles.locInput} textAlign={"center"} />
